...
class ConfigTests {
    ...
    fun `get and set all config states`() {
        ...
        assertEquals(Color(0xFFFFFFFF), config.states.commandLineBackgroundColor.value)
        ...
        assertEquals(8000, config.states.canvasLimit.value)
        ...
        assertIs<Result.Success<Boolean>>(config.setValue(ConfigKeys.COMMAND_LINE_BACKGROUND_COLOR, color))
        ...
        assertEquals(color.toColorOrNull(), config.states.commandLineBackgroundColor.value)

...
class EdgeRepository(database: GraphDatabase) {
    ...
    fun insertEdge(graphId: Long, fromVertex: Long, toVertex: Long, weight: Long?) {
    ...
    fun updateEdgeByGraphAndVertices(graphId: Long, newWeight: Long?, fromVertex: Long, toVertex: Long) {
        edgeQueries.updateEdgeByGraphAndVertices(weight = newWeight, graph_id = graphId, from_vertex = fromVertex, to_vertex = toVertex)
    }

    fun deleteEdgeByGraphAndVertices(graphId: Long, fromVertex: Long, toVertex: Long) {

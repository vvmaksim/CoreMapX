...
class ConfigStates(
    ...
    val cancelIconColor = mutableStateOf(configRepository.getColor("cancelIconColor"))
    ...
    fun updateValue(
        ...
        when (key) {
            ...
            "cancelIconColor" -> cancelIconColor.value = configRepository.getColor("cancelIconColor")
